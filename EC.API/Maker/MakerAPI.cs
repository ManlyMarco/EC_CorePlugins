...
namespace KKAPI.Maker
{
    ...
    public static partial class MakerAPI
    {
        ...
        private static void AddMissingSubCategories(UI_ToggleGroupCtrl mainCategory)
        {
            ...
            var transformsToSort = new List<System.Tuple<Transform, int>>();
            foreach (var category in _categories)
            {
                ...
                transformsToSort.Add(new System.Tuple<Transform, int>(categorySubTransform, category.Position));
            }
            ...
            foreach (Transform subTransform in categoryTransfrom)
            {
                ...
                if (builtInCategory != null)
                    transformsToSort.Add(new System.Tuple<Transform, int>(subTransform, builtInCategory.Position));
                else
